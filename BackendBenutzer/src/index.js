...
const configBenutzer = {
  port:    parseInt(process.env.PORT) || 3001,
  host:    process.env.HOST           || "localhost",
  mongodb: process.env.MONGODB        || "172.18.0.5db://localhost:27016",
};

await DatabaseFactory.init(configBenutzer.mongodb);
